...
public class TestCases
{
   ...
   public void testSimpleIf3()
   {
      ...
      assertEquals(7.0, SimpleIf.max(-1.0, 7.0), DELTA);
   }
   ...
   public void testSimpleArray3()
   {
      ...
      assertArrayEquals(new int[] {1, 0, 1, 4}, SimpleArray.squareAll(new int[] {-1, 0, 1, 2}));
   }
   ...
   public void testSimpleList2()
   {
      ...
      /* TO DO: Add a new test case. */
      List<Integer> input =
         new LinkedList<Integer>(Arrays.asList(new Integer[] {-1, 0, -1}));
      List<Integer> expected =
         new ArrayList<Integer>(Arrays.asList(new Integer[] {1, 0, 1}));
   ...
   public void testBetterLoop3()
   {
      ...
      assertFalse(BetterLoop.contains(new int[] {1, 2, 3}, 8));
   }
   ...
   public void testExampleMap2()
   {
      ...
      List<String> expected = Arrays.asList("Hatalsky", "Workman");
      Map<String, List<Course>> courseListsByStudent = new HashMap<>();

      courseListsByStudent.put("Hatalsky",
         Arrays.asList(
            new Course("CPE 123", 7),
            new Course("CPE 101", 4),
            new Course("CPE 202", 8),
            new Course("CPE 203", 4),
            new Course("CPE 225", 4)));
      courseListsByStudent.put("Paul",
         Arrays.asList(
      ...
      courseListsByStudent.put("Workman",
         Arrays.asList(
            new Course("CPE 123", 23)));
